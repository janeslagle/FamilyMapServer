...
public class Server {
	...
	private void run(String portNumber) {
		...
		// Create and install the HTTP handler for all of the paths have in lab spec
		// When the HttpServer receives an HTTP request containing these URL paths, it will forward the requests
		// to their handler classes for processing
